...
data:
  ...
  bundledCode: "#line 1 \"test/polygon_diameter.test.cpp\"\n#include <bits/stdc++.h>\n\
  ...
  verifiedWith: []
documentation_of: test/polygon_diameter.test.cpp
layout: document
redirect_from:
- /verify/test/polygon_diameter.test.cpp
- /verify/test/polygon_diameter.test.cpp.html
