...
data:
  ...
  bundledCode: "#line 1 \"test/proj.test.cpp\"\n#include <bits/stdc++.h>\nusing namespace\
  ...
  verifiedWith: []
documentation_of: test/proj.test.cpp
layout: document
redirect_from:
- /verify/test/proj.test.cpp
- /verify/test/proj.test.cpp.html
